  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-bed"></i> <span>Hotles</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{ route('admin.hotels.index') }}">All Hotels</a></li>
            <li><a href="{{ route('admin.hotels.create') }}">Add New Hotel</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#"><i class="fa fa-globe"></i> <span>Tour Packages</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
